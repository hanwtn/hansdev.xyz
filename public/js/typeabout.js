class TextTyper {
  ...
  skip() {
    this.chain( () => this.container.innerText = `Hello, my name's Han Win Tun. You can call me Hans. I am a 19-year-old-burmese.
\nmy things ↓`);
    return this;
  }
  stop() {
  ...
  switch (btnId) {
    ...
    case 'coding':
     $(document).ready(function() {
      ...
      typer
        .clearNow()
        .type("I like tinkering with some code.", 1000);
      break;
    case 'photography':
     $(document).ready(function() {
      $('#link-icon').hide()
    ...
    case 'travel':
     $(document).ready(function() {
      ...
      typer
        .clearNow()
        .type("I like vacations.", 1000);
      break;
    case 'music':
        $(document).ready(function() {
      document.getElementById('link-icon').className = "fab fa-spotify";
      document.getElementById('link-icon-a').setAttribute("href", "https://open.spotify.com/user/0b6qzvfhx22divy2ffgwrpzuk?si=9Y1pLkI9SVSP3RxWn6o4OA");
       });
      typer
        .clearNow()
        .type("I listen mostly to melodic dubsteps. Check out my playlists on Spotify.", 1000);
      $(document).ready(function() {
    ...
    case 'shows':
      ...
      document.getElementById('link-icon-a').setAttribute("href", "https://boxd.it/3nPLh");
       });
      typer
        .clearNow()
        .type("I binge tv shows. Check out my letterboxd!", 1000);
      $(document).ready(function() {
    ...
    case 'gaming':
     $(document).ready(function() {
      ...
      typer
        .clearNow()
        .type("I play moba and battle royale.", 1000);
      break;
    case 'chess':
     $(document).ready(function() {
      $('#link-icon').hide()
      ...
      typer
        .clearNow()
        .type("Challenge me on chess dot com. :)", 1000);
      break;
    case 'coffee':
     $(document).ready(function() {
      $('#link-icon').hide()
